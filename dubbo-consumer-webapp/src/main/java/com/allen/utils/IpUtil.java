 ...
 * Company:     HQYG.
 * author:      cf
 * Createdate:  2017年3月7日下午4:19:43
 */
public class IpUtil implements Serializable{
	
	/*UPDATE ip_country SET ip_start = inet_aton(SUBSTRING(ip_str, 1, LOCATE('/', ip_str) - 1)), ip_end = (inet_aton(SUBSTRING(ip_str, 1, LOCATE('/', ip_str) - 1)) + (pow(2, (32-CONVERT(SUBSTRING(ip_str, LOCATE('/', ip_str) + 1), UNSIGNED INT)))-1));*/
	
	
	private static final long serialVersionUID = -1778100614334888725L;
